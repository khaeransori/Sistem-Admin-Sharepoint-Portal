<%@ page title="Student Information" language="C#" masterpagefile="~/Dashboard.master" autoeventwireup="true" inherits="Administrator_Student_StudentInformation, App_Web_hnt0g5tj" %>
            ...
            <ul>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <asp:Button ID="UnlockUserButton" runat="server" Text="Unlock Student" OnClick="UnlockUserButton_Click" />
                    </div>
                </li>
                <li class="button">
